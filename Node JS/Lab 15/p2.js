...
async function dbConnect() {                        // conection function
    ...
    let col = db.collection('students')         // connection of collection
    ...
    const result2 = await col.updateMany({ name: "Kishan", "rollNo": 555 }, { $set: { name: "ASDF", rollNo: 444 } }); // update data array function
